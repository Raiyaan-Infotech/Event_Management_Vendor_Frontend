...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(vendorUi.panel.base, "text-[var(--vendor-text)] flex flex-col gap-5 py-5", className)}
      {...props}
    />
  )
}
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(vendorUi.type.sectionTitle, "leading-none", className)}
      {...props}
    />
  )
}
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-[var(--vendor-text-muted)] text-[var(--vendor-subtitle-text)]", className)}
      {...props}
    />
  )
}
