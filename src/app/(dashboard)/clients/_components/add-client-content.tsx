...
export function AddClientContent({
  ...
  const [formData, setFormData] = useState({
    ...
    district: (initialData?.district as string) || "",
    city: (initialData?.city as string) || "",
    locality: (initialData?.locality as string) || "",
            ...
            >
              ...
              <div className="pt-4 border-t border-gray-100 dark:border-gray-800 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${loginAccess ? "translate-x-6" : "translate-x-1"}`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${sendCredentialsToEmail ? "translate-x-6" : "translate-x-1"}`}
                    />
                  </button>
                </div>
              </div>
