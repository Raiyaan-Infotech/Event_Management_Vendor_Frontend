...
import { useAddSocialLink } from '@/hooks/use-vendor-social-links';
...
export default function AddSocialLinkPage() {
  ...
  const addMutation = useAddSocialLink(() => router.push('/website/social-links'));
  ...
  return (
    <div className="h-[calc(100vh-86px)] overflow-y-auto px-6 py-8 custom-scrollbar">
      <div className="max-w-[1700px] mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-[#1e293b] dark:text-white mb-1">Add Social Link</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">Create a new social media link.</p>
        </div>
          ...
          <div className="lg:col-span-3 lg:sticky lg:top-8 space-y-4">
            ...
            <div className="bg-white dark:bg-sidebar/50 p-5 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
              <PersistenceActions
                ...
                saveLabel={addMutation.isPending ? 'SAVING...' : 'ADD LINK'}
